...
A satisfying answer should explain attention sinks, long-prefix behaviour, and judge calibration in plain language; connect them to my prompted judge’s 100% precision / 76.92% recall pattern; and give me a runnable ablation plan that measures false negatives, good-vs-bad log-prob margins, and strict pairwise accuracy under different prompt layouts.
