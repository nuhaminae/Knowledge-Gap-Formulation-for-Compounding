...
On my peer's [Conversion Engine project](https://github.com/YohannesDereje/The-Conversion-Engine), his `agent_core.py` Phase 5 (~lines 461-503), SOC-01 proved that embedding the honesty constraint in the system prompt was not sufficient — the model generated "you are rapidly scaling your team" despite an explicit instruction not to. The fix was to inject a follow-up user turn mid-conversation naming the specific violation and requesting a rewrite, and that second attempt passed.
